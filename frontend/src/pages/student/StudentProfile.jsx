  ...
  return (
    <div className="min-h-screen bg-slate-50 p-6 md:p-8">
      ...
      <div className="mb-8 flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
        ...
        <button className="rounded-xl bg-blue-600 text-white font-semibold px-6 py-2.5 shadow-sm hover:bg-blue-700 transition">
          Edit Profile
        </button>
      </div>
      ...
      <div className="mb-8 flex items-center gap-4 rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
        ...
        <div>
          <p className="text-base font-semibold text-slate-800">Student Name</p>
          <p className="text-sm text-slate-500">student@email.com</p>
          <p className="mt-1 text-xs font-medium text-blue-600">Computer Science · Final Year</p>
        </div>
      </div>
      ...
      <div className="mb-8 grid grid-cols-1 gap-6 md:grid-cols-3">
        <div className="rounded-2xl border border-blue-100 bg-gradient-to-br from-blue-50 to-white p-6">
          ...
          <p className="mt-3 text-xs text-slate-500">Total applications submitted</p>
        </div>
        ...
        <div className="rounded-2xl border border-green-100 bg-gradient-to-br from-green-50 to-white p-6">
          ...
          <h2 className="mt-2 text-4xl font-bold text-slate-900">—</h2>
          <p className="mt-3 text-xs text-slate-500">Assessed and confirmed skills</p>
        </div>
        ...
        <div className="rounded-2xl border border-purple-100 bg-gradient-to-br from-purple-50 to-white p-6">
          ...
          <h2 className="mt-2 text-4xl font-bold text-slate-900">—</h2>
          <p className="mt-3 text-xs text-slate-500">Average opportunity fit</p>
        </div>
      </div>
      ...
      <div className="mb-6 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
        <div className="mb-6 flex items-center justify-between">
          <div>
            <h2 className="text-xl font-bold text-slate-900">🧩 My Skills</h2>
            <p className="mt-1 text-sm text-slate-500">Skills you've added or been assessed on</p>
          </div>
        ...
        <div className="rounded-xl border border-dashed border-slate-200 bg-slate-50 px-6 py-12 text-center">
          ...
          <p className="mt-3 font-medium text-slate-700">No skills added yet</p>
